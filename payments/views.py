...
class PaymentView(APIView):
    ...
    def get(self, request):
        ...
        return Response({'token': payment.token,
                         'callback_url' : 'https://my-site.com/payments/pay/'})
    ...
    def post(self, request):
        ...
        if st != 10:
            ...
            payment.save()
            return Response({'detail' :'Payment verification has failed'},
        ...
        Subscription.objects.create(
            ...
            expires = timezone.now() + timezone.timedelta(days=payment.package.duration.days)
        )

        return Response({'detail' :'Payment verification has succeeded'},
